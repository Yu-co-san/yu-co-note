...
const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({ location }) => {
  return (
    <Layout location={location}>
      <Wrapper className="inner">
        ...
        <h2>1. 個人情報の利用目的</h2>
        <p>
        yuco-note.net(以下当ブログ)では、お問い合わせ、メールマガジンへの登録などの際に、名前（ハンドルネーム）、メールアドレス等の個人情報をご登録いただく場合がございます。
        </p>
        <p>
        ...
        <h2>4.広告の配信について</h2>
        <p>
          当ブログは第三者配信の広告サービス「Google Adsense
          グーグルアドセンス」を利用しています。
        </p>
        <p>
        ...
        <p>
          このGoogleアナリティクスはトラフィックデータの収集のためにCookieを使用しています。このトラフィックデータは匿名で収集されており、個人を特定するものではありません。この機能はCookieを無効にすることで収集を拒否することが出来ますので、お使いのブラウザの設定をご確認ください。Google
          Analyticsの利用により収集されたデータは、
          <a
...
export const Head: React.FC<HeadProps> = (props) => {
  return <Seo title="プライバシーポリシー" noindex />;
};
